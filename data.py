...
for n in np.arange(0,number_of_articles):
    ...
    #dictionary = {'title': title_dawn, 'links': links_dawn, 'author': author_dawn, 'article': articles_dawn,
                #  'publish_date': all_publish_date, 'source': 'dawn'}
    #df = pd.DataFrame (dictionary)
    #to_csv = df.to_csv ('C:/Users/Lenovo/Desktop/Vikas.data.csv')

    db = mysql.connector.connect(user="root", database="vicky", password="T#9758@qlph")
    cursor = db.cursor()
